/*
 * ArcitypeKinematics.h
 *
 *  Created on: 24 Apr 2017
 *      Author: David
 */

#ifndef SRC_MOVEMENT_KINEMATICS_ARCITYPEKINEMATICS_H_
#define SRC_MOVEMENT_KINEMATICS_ARCITYPEKINEMATICS_H_

#include "ZLeadscrewKinematics.h"

#if SUPPORT_ARCITYPE

// Standard setup for ARCITYPE machines assumed by this firmware
...
class ArcitypeKinematics : public ZLeadscrewKinematics
{
public:
	// Constructors
	ArcitypeKinematics() noexcept;
...
#endif /* SRC_MOVEMENT_KINEMATICS_ARCITYPEKINEMATICS_H_ */
